...
- Name: tests\expense.spec.js >> Expense Tracker - Full Coverage Suite >> Negative expense amount validation
- Location: tests\expense.spec.js:123:3
...
Call log:
  - waiting for locator('.expense-item').filter({ hasText: 'Invalid Expense' }).first() to be visible
