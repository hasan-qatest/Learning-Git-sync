...
- Name: tests\expense.spec.js >> Expense Tracker - Full Coverage Suite >> Reset application clears all data
- Location: tests\expense.spec.js:158:3
...
Call log:
  - waiting for locator('text=Reset')
    - locator resolved to 2 elements. Proceeding with the first one: <p>Enter your total budget for the month. You can re…</p>
