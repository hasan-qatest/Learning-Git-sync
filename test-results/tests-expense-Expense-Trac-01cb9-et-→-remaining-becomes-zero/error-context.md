...
- Name: tests\expense.spec.js >> Expense Tracker - Full Coverage Suite >> Expense equal to budget → remaining becomes zero
- Location: tests\expense.spec.js:53:3
...
Call log:
  - waiting for locator('.expense-item').filter({ hasText: 'Shopping' }).first() to be visible
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e29]:
    ...
    - generic [ref=e32]:
      ...
      - textbox "e.g. Groceries, Rent, Transport…" [ref=e34]: Shopping
    - generic [ref=e35]:
